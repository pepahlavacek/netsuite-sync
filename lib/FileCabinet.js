...
function init(configFile) {
    if (configFile) {
        try {
            nsConf = eval(secureConfig.decryptFile(configFile));
        } catch(e) {
            nsConf = eval(secureConfig.decryptFile("NetSuiteConfig.js.enc"));
        }
    } else {
        nsConf = eval(secureConfig.decryptFile("NetSuiteConfig.js.enc"));
    }
 ...
 */
module.exports.postFile = function (configFile, filename, description, folder, callback) {
    init(configFile);
